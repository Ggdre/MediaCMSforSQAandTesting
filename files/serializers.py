...
class SingleMediaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "poster_url",
            "thumbnail_time",
            # Fix: "url" was listed twice in this tuple (originally at index 0 and
            # again at index 13). The duplicate is harmless to DRF but wastes a
            # serialization slot and indicates a copy-paste error.
            "sprites_url",
            "preview_url",
            "author_name",
            "author_profile",
